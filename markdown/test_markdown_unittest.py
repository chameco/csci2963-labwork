...
class TestMarkdownPy(unittest.TestCase):
    ...
    def test_h3(self):
        '''
        Lines surrounded by triple octothorpes should be wrapped in 'h3' tags
        '''
        self.assertEqual(
    ...
    def test_h2(self):
        '''
        Lines surrounded by double octothorpes should be wrapped in 'h2' tags
        '''
        self.assertEqual(
    ...
    def test_h1(self):
        '''
        Lines surrounded by single octothorpes should be wrapped in 'h1' tags
        '''
        self.assertEqual(
    ...
    def test_block(self):
        '''
        Lines preceded by single greater-thans should be wrapped in 'blockquote' tags
        '''
        self.assertEqual(
                run_markdown('>block\n>block2'),
                '<blockquote>\nblock\nblock2\n</blockquote>')
